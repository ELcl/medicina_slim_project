                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid gap-4 mx-8 sm:grid-cols-4">
                        <div class="sm:col-span-1">
                            <x-dashboard_card title="USUARIOS" cantidad={{$users}}>
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <x-dashboard_card title="PACIENTES" cantidad={{$pacientes}}>
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <x-dashboard_card title="CASOS DE VIOLENCIA" cantidad={{$casos}}>
