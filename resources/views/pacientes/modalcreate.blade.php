            ...
            <form method="post" action="{{route('pacientes.store')}}"  >
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-4">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <select name="procedencia" id="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <select name="residencia" id="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <option selected value="ACHOCALLA">ACHOCALLA</option>
                            <option value="CORIPATA">CORIPATA</option>
                            <option value="LAJA">LAJA</option>
                            <option value="SAPAQUI">SAPAQUI</option>
                            <option value="SANTIAGO DE HUATA">SANTIAGO DE HUATA</option>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <select name="ocupacion" id="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <option selected value="AGRICULTURA">AGRICULTURA</option>
                            <option value="GANADERIA">GANADERÍA</option>
                            <option value="ARTESANÍA Y OFICIOS">ARTESANÍA Y OFICIOS</option>
                            <option value="COMERCIO LOCAL">COMERCIO LOCAL</option>
                            <option value="SERVICIOS PUBLICOS Y EDUCACION">SERVICIOS PÚBLICOS Y EDUCACIÓN</option>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <select name="fuente" id="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <option selected value="PROPIA">PROPIA</option>
                            <option value="DE UN FAMILIAR">DE UN FAMILIAR</option>
                            <option value="DE UN REPORTE">DE UN REPORTE</option>
                            <option value="OTROS">OTROS</option>
                        </select>
                    </div>
                    <div class="sm:col-span-2">
                ...
                <button type="button" class="bg-gray-500 text-white inline-flex items-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" data-modal-toggle="creaPaciente">
                    {{-- <svg aria-hidden="true" class="mr-1 -ml-1 w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clip-rule="evenodd"></path></svg> --}}
                    Cancelar
                    <span class="sr-only">Close modal</span>
                </button>
